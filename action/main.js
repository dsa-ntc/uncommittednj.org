...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('.icons.style2', { style: 'fade-down', speed: 750, intensity: 1, threshold: 3, delay: 0, stagger: 125, staggerSelector: ':scope > li', replay: false });
		onvisible.add('.container.style2 > .wrapper > .inner', { style: 'fade-left', speed: 750, intensity: 2, threshold: 3, delay: 125, replay: false });
		onvisible.add('.container.style1 > .wrapper > .inner', { style: 'fade-left', speed: 750, intensity: 2, threshold: 3, delay: 125, replay: false });
		onvisible.add('.image.style1', { style: 'zoom-in', speed: 750, intensity: 4, threshold: 3, delay: 0, replay: false });
		onvisible.add('.image.style3', { style: 'zoom-in', speed: 750, intensity: 4, threshold: 3, delay: 0, replay: false });
		onvisible.add('.buttons.style1', { style: 'fade-up', speed: 750, intensity: 2, threshold: 3, delay: 0, stagger: 125, staggerSelector: ':scope > li', replay: false });
